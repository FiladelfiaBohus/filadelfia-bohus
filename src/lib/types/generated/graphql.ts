...
export type Navigation = Entity & Node & {
  ...
  /** The unique identifier */
  id: Scalars['ID']['output'];
  menuItems?: Maybe<NavigationmenuItemsUnion>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  /** User that last published this document */
  publishedBy?: Maybe<User>;
...
export type NavigationCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  menuItems?: InputMaybe<NavigationmenuItemsUnionCreateOneInlineInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type NavigationManyWhereInput = {
  ...
  menuItems?: InputMaybe<NavigationmenuItemsUnionWhereInput>;
  /** All values in which the union is empty. */
...
export type NavigationUpdateInput = {
  menuItems?: InputMaybe<NavigationmenuItemsUnionUpdateOneInlineInput>;
};
...
export type HeroFragment = { __typename?: 'Hero', id: string, title?: string | null, stage: Stage, image: { __typename?: 'Asset', size?: number | null, url: string } } & { ' $fragmentName'?: 'HeroFragment' };

export type NavLinkFragment = { __typename?: 'NavLink', id: string, page?: { __typename?: 'Page', slug?: string | null, title?: string | null } | null } & { ' $fragmentName'?: 'NavLinkFragment' };

export type HomePageFragment = { __typename?: 'HomePage', id: string, content: Array<(
    { __typename?: 'Hero' }
...
export type NavigationQueryQuery = { __typename?: 'Query', navigation?: { __typename?: 'Navigation', id: string, menuItems?: (
      { __typename?: 'NavLink' }
      & { ' $fragmentRefs'?: { 'NavLinkFragment': NavLinkFragment } }
    ) | null } | null };

export type PageFragment = { __typename?: 'Page', id: string, slug?: string | null, content: Array<(
    { __typename?: 'Hero' }
    & { ' $fragmentRefs'?: { 'HeroFragment': HeroFragment } }
...
export const NavigationQuery = gql`
  ...
  navigation(where: {id: "cltvzxqzzjzmx07urcg4ircdf"}) {
    id
    menuItems {
      ...navLink
    }
